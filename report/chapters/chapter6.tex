...
Chương 5 đã phân tích chuyên sâu ba đóng góp kỹ thuật nổi bật của đồ án, cho thấy hệ thống đã giải quyết được các thách thức kỹ thuật cốt lõi đặt ra từ chương 1. Chương 6 khép lại đồ án với hai nội dung: tổng hợp và đánh giá toàn bộ kết quả đạt được cùng các hạn chế còn tồn tại trong mục 6.1, và đề xuất sáu hướng phát triển tiềm năng để nâng cao và mở rộng hệ thống trong tương lai trong mục 6.2.
...
\begin{itemize}
  ...
  \item \textbf{Hệ thống quản lý thuật ngữ:} Ba cấp (Private Library, Suggestion Queue,
    Common Library) với 45 cặp glossary Google Translation API (C(10,2) với 10 ngôn ngữ
    mặc định, tự động mở rộng khi thêm ngôn ngữ) hoạt động tự động, cho phép doanh nghiệp
    duy trì bộ từ điển kỹ thuật nhất quán qua cơ chế đề xuất cộng đồng.
...
\begin{itemize}
  ...
  \item \textbf{Cập nhật glossary bất đồng bộ:} Sau khi duyệt thuật ngữ, glossary Google
    Translation được cập nhật trong background thread (30--180~giây/pair × 45 pairs). Trong
