...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        # Django's authenticate() silently rejects inactive users, which would make
        # the is_active check below unreachable — so verify the password directly
        # against the ORM user instead of going through authenticate().
