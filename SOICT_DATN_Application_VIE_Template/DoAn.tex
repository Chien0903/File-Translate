...
\usepackage{longtable} % Tạo bảng dài qua nhiều trang
...
\newglossarystyle{customglos}{%
  \renewenvironment{theglossary}%
    {\begin{longtable}{|p{0.2\textwidth}|p{0.72\textwidth}|}}%
    {\end{longtable}}%
  \renewcommand*{\glossaryheader}{%
    \hline
    \textbf{Thuật ngữ} & \textbf{Ý nghĩa} \tabularnewline
    \hline\endhead
    \hline\endfoot%
  }%
  \renewcommand*{\glsgroupskip}{}%
  \renewcommand*{\glossentry}[2]{%
    \glsentryname{##1} & \glsentrydesc{##1} \tabularnewline\hline
  }%
}
\setglossarystyle{customglos}
\usepackage{setspace}
\usepackage{parskip}
