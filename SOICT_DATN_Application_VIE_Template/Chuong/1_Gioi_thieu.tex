...
Vấn đề thứ nhất là sự thiếu nhất quán trong thuật ngữ chuyên ngành. Khi sử dụng các công cụ dịch rời rạc hoặc dịch thủ công, doanh nghiệp khó kiểm soát việc cùng một thuật ngữ được dịch nhất quán giữa các tài liệu, phòng ban hay dự án khác nhau. Điều này ảnh hưởng trực tiếp đến tính chính xác và tính chuyên nghiệp của nội dung tài liệu.

Vấn đề thứ hai là việc mất cấu trúc và định dạng tài liệu sau khi dịch. Với các tài liệu có bảng biểu, hình ảnh, bố cục phức tạp hoặc nhiều thành phần trình bày, phần lớn công cụ dịch hiện tại chỉ trả về văn bản thuần, buộc người dùng phải tốn thêm thời gian chỉnh sửa lại định dạng thủ công sau khi dịch.
